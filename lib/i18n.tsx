...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    langName_he: "Hebrew",
    langName_fr: "French",
    menuLangBannerText: "This menu is in {source}. Would you like to view a machine translation in {target}?",
    menuLangTranslate: "Translate",
    menuLangNotNow: "Not now",
  ...
  he: {
    ...
    langName_he: "עברית",
    langName_fr: "צרפתית",
    menuLangBannerText: "התפריט כתוב ב{source}. לצפות בתרגום אוטומטי ל{target}?",
    menuLangTranslate: "תרגם",
    menuLangNotNow: "לא עכשיו",
  ...
  fr: {
    ...
    menuLangBannerText: "Ce menu est en {source}. Voulez-vous afficher une traduction automatique en {target}?",
    menuLangTranslate: "Traduire",
    menuLangNotNow: "Pas maintenant",
