...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    aiGreeting: "Hi! I'm {name}'s ordering assistant. Want me to help you put together your order?",
  ...
  he: {
    ...
    aiGreeting: "היי! אני עוזר ההזמנות של {name}. רוצה שאעזור לך להרכיב את ההזמנה?",
  ...
  fr: {
    ...
    aiGreeting: "Bonjour ! Je suis l'assistant de commande de {name}. Voulez-vous que je vous aide à composer votre commande ?",
