...
export function pageAppearanceVariables(
  ...
  Object.assign(
    ...
    styleVariables(normal, [
      ...
      ["accent", "--cat-accent"],
      ["divider", "--cat-divider"],
      ["activeBg", "--cat-active-bg"],
      ["activeText", "--cat-active-text"],
      ["searchBg", "--cat-search-bg"],
      ["searchText", "--cat-search-text"],
      ["iconBg", "--cat-icon-bg"],
      ["icon", "--cat-icon"],
      ["cartBg", "--cat-cart-bg"],
    ...
    styleVariables(sticky, [
      ...
      ["activeBg", "--cat-sticky-active-bg"],
      ["activeText", "--cat-sticky-active-text"],
      ["searchBg", "--cat-sticky-search-bg"],
      ["searchText", "--cat-sticky-search-text"],
      ["iconBg", "--cat-sticky-icon-bg"],
      ["icon", "--cat-sticky-icon"],
      ["cartBg", "--cat-sticky-cart-bg"],
      ["cartText", "--cat-sticky-cart-text"],
    ]),
  );
  return variables;
}
