 ...
 * Orders. Hidden from `md` up (desktop keeps the drawer). The cart is reached via
 * the floating cart dock (which sits just above this bar), so there is no cart tab
 * here — that would duplicate the dock.
 */
